...
Brand.storyName = `🔶 ProductRow`;
export const DesktopProfileRow: Story = {
  render: (args) => (
    <Alert color="error">{`Obsolete: Use <ProfileRow /> component`}</Alert>
  )
};
export const MobileProfileRow: Story = {
  render: (args) => (
    <Alert color="error">{`Obsolete: Use <ProfileRow /> component`}</Alert>
  )
};
